...
# RIGID_BODY_LIST  = ["flying_object", "flying_object_2", "go1"]
RIGID_BODY_LIST  = ["flying_object", "fan", "go1"]
def trace( *args ):
...
class NatNetClient:
    def __init__( self ):
        ...
        #  rigid_body_list = ["target1","target2", "go1_1", "empty_bottle", "go1_2"]
        #  rigid_body_list = ["frisbee_ring"]
        rigid_body_list = RIGID_BODY_LIST
